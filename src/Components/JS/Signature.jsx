...
const Signature = () => {
    ...
    const saveToDatabase = async () => {
        ...
        if (signatureType != 'ELECTRONIC') {
            try {
                await axios.post(`${baseUrl}${apiEndpoint}`, signatureData, { headers });
    ...
    return (
        <div className="box">
            ...
            <div className="d-flex justify-content-center">
            <Form.Item>
            <Button type="primary" onClick={showModal} disabled={isSignatureAdded} className="me-5">
                Click Here To Sign
            </Button>
            </Form.Item>
            <Form.Item>
                <Button type="primary" onClick={saveToDatabase} className="btn btn-success ms-5">
                    Submit
                </Button>
            </Form.Item>
            </div>
