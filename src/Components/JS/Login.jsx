...
const Login = () => {
        ...
        const handleLogin = async () => {
                await axios.post('http://localhost:8080/api/v1/auth/login', loginData).then(
                        (response) => {
                                        ...
                                        <Form onFinish={handleLogin} style={{marginTop:"40px"}}>
                                                ...
                                                <div className="d-flex flex-column justify-content-center mt-4" style={{ width: "280px" }}>
                                                        ...
                                                        <Form.Item style={{ margin: "0" }}>
                                                                <p style={{ margin: "0", padding: "0",marginTop:"-21px" }}>Forgot Password ?</p>
                                                        </Form.Item>
                                                        <Form.Item className="text-center"  style={{ margin: "0" }}>
                                                                <Button htmlType="submit" type="primary" icon={<LockOutlined />} size={size} style={{ width: "280px", backgroundColor: '#589A65'}}>
                                                                        Login
                                                                </Button>
                                                        </Form.Item>
                                                        <Form.Item className="text-center">
                                                        <p className="mt-3">Don't Have an Account ? <span style={{color:"#589A65",fontWeight:"700"}}>SignUp</span></p>
                                                        </Form.Item>
                                                </div>
                                        </Form>
                                </div>
